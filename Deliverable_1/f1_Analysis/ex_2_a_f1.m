...
for k = 1:length(L)
    ...
    xlabel('X');
    ylabel('f1(x)');
    title(sprintf('f1 με l = %g', l));
end

sgtitle('Απεικόνιση της f1 για διαφορετικές τιμές l με τη μέθοδο του Χρυσού Τομέα');
